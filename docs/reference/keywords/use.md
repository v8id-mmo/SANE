...
Pulls a [`unit`](unit.md) (a `.tru` file) into the current compile. The
...
[`unit`](unit.md), in the same folder)
...
similar; see [`sizeof`](sizeof.md)'s neighbors for the full builtin list)
